...
module.exports = class DataUploader {
  ...
  sync_personal_OffistaData(record) {
    ...
    const enrollEmploymentInsurance = TRANSFER_LIST.enroll_employment_insurance.fields;
    ...
    else if (record["連絡種別"].value === "家族の追加") {
      transferFields = essential;
    }
    else if (record["連絡種別"].value === "家族の扶養変更") {
      transferFields = essential;
    }
